                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select name="type" class="form-control" required x-on:change="userType = $event.target.value">
                                    <option value="{{ $model::TYPE_USER }}" {{ $user->type === $model::TYPE_USER ? 'selected' : '' }}>Customer</option>
                                    <option value="{{ $model::TYPE_SUPPLIER }}" {{ $user->type === $model::TYPE_SUPPLIER ? 'selected' : '' }}>Supplier</option>
                                </select>
                            </div>
                        </div><!--form-group-->
                    @endif
